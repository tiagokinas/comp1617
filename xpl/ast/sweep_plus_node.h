...
namespace xpl {
  ...
  /**
   * Class for describing sweepplus-cycle nodes.
   */
  ...
  public:
    inline sweep_plus_node(int lineno, cdk::lvalue_node *lvalue, cdk::expression_node *expression1, cdk::expression_node *expression2, cdk::expression_node *expression3,cdk::basic_node *block) :
        basic_node(lineno), _lvalue(lvalue), _expression1(expression1), _expression2(expression2), _expression3(expression3), _block(block){
    }
     
    inline sweep_plus_node(int lineno, cdk::lvalue_node *lvalue, cdk::expression_node *expression1, cdk::expression_node *expression2, cdk::basic_node *block) :
