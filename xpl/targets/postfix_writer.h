...
namespace xpl {
  ...
  class postfix_writer: public basic_ast_visitor {
    ...
    std::vector<int> _labelNextCycle;
    std::vector<int> _labelStopCycle;
    bool function = false;
  ...
  public:
    ...
    void do_sweep_less_node(xpl::sweep_less_node * const node, int lvl);
    ...
    void do_variable_initialization_node(xpl::variable_initialization_node * const node, int lvl);
    void do_index_node(xpl::index_node * const node, int lvl){}
    void do_adress_of_node(xpl::adress_of_node * const node, int lvl){}
    void do_alloc_node(xpl::alloc_node * const node, int lvl){}
