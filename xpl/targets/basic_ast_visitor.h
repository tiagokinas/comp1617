...
public:
  ...
  virtual void do_sweep_less_node(xpl::sweep_less_node * const node, int lvl) = 0;
  virtual void do_sweep_plus_node(xpl::sweep_plus_node * const node, int lvl) = 0;
  virtual void do_variable_declaration_node(xpl::variable_declaration_node * const node, int lvl) = 0;
  virtual void do_variable_initialization_node(xpl::variable_initialization_node * const node, int lvl) = 0;
  virtual void do_index_node(xpl::index_node * const node, int lvl) = 0;
  virtual void do_adress_of_node(xpl::adress_of_node * const node, int lvl) = 0;
  virtual void do_alloc_node(xpl::alloc_node * const node, int lvl) = 0;
